...
//    GROUP_OTHER(listOf(NavigationMenu.EXPORT, NavigationMenu.CHANNEL_AVAILABLE, NavigationMenu.VENDORS, NavigationMenu.PORT_AUTHORITY)),
    GROUP_OTHER(listOf(NavigationMenu.CHANNEL_Ping, NavigationMenu.CHANNEL_Mtr, NavigationMenu.CHANNEL_Oip, NavigationMenu.CHANNEL_Ns)),
    GROUP_INFO(listOf(NavigationMenu.WIFI_INFO,NavigationMenu.WIFI_PASS)),
