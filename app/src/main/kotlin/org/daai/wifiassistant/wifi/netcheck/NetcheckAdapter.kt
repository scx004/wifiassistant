...
import org.daai.wifiassistant.databinding.NetcheckDetailsBinding
import org.daai.wifiassistant.wifi.band.WiFiBand
import org.daai.wifiassistant.wifi.band.WiFiChannelCountry

internal class NetcheckAdapter(context: Context, wiFiChannelCountries: List<WiFiChannelCountry>) :
        ArrayAdapter<WiFiChannelCountry>(context, R.layout.netcheck_details, wiFiChannelCountries) {

    override fun getView(position: Int, view: View?, parent: ViewGroup): View {
        val binding = view?.let { NetcheckAdapterBinding(it) } ?: NetcheckAdapterBinding(create(parent))
    ...
    private fun create(parent: ViewGroup): NetcheckDetailsBinding =
        NetcheckDetailsBinding.inflate(MainContext.INSTANCE.layoutInflater, parent, false)
